...
public class NumberGuess 
{
	public static void main(String[] args) 
	{
		 ...
		 NumberGuess ex=new NumberGuess();
		 ex.guessGame();
		 while(true)
		 {
...
//		 System.out.println(rr);
		 for(int j=1;j<=5;j++)
		 {
		  ...
		  if (rr==guess && (j==1||j==2||j==3||j==4||j==5))
		  {
			System.err.println("You have Guessed Correct Number in "+ j+" Attempt Your SCORE is: "+(j));
			return;
	   	  }
		  else if (rr!=guess && j>5) 
		  {
